			...
			<div class="col-12">
				<table id="data_table" class="table table-borderless table-hover table-sm w-100">
					<thead class="thead-light">
						<tr><th data-filtertype="text" data-filterid="idf">#</th><th data-filtertype="text" data-filterid="urlf">' . __(
                'URL'
            ) . '</th><th data-filtertype="select" data-filterid="languagef" data-options=\'' . json_encode(
                $languageOptions,
                JSON_FORCE_OBJECT
            ) . '\'>' . __('Language') . '</th><th data-filtertype="text" data-filterid="titlef">' . __(
                'Title'
            ) . '</th><th data-filtertype="text" data-filterid="menutextf">' . __('Menu text') . '</th><th>' . __(
                'Actions'
            ) . '</th></tr>
					</thead>
					<tbody>
                    ...
                    <div class="col-12 col-md-3">
                        <div class="form-group">
                            <div class="input-group">
                                <select class="form-control" id="edlanguage" name="edlanguage">' . Util::arrayToOptions(
                $languageOptions
            ) . '</select>
