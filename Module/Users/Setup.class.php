...
class Setup extends \Module\Setup {
	public function __construct() {
		parent::__construct();
		$this->registerFrontendUrl(array('url' => 'login', 'type' => 0, 'mustBeLoggedIn' => 0, 'hiddenForLoggedIn' => 1, 'menu_position' => 2, 'menu_text' => 'Login'));
		...
		$this->registerBackendUrl(array('permission' => 'View users', 'url' => 'users', 'menu_text' => 'Users', 'menu_class' => 'users'));
	}
}