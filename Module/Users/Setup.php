...
{
    const PERMISSION = 'View users';
    const ENTITY = 'users';

    public function __construct()
    {
        parent::__construct();
        $this->registerFrontendUrl(
            array(
                'url' => 'login',
                'type' => 0,
                'mustBeLoggedIn' => 0,
        ...
        $this->registerFrontendUrl(
            array(
                ...
                'mustBeLoggedIn' => 1,
                'menu_position' => 2,
                'menu_text' => 'My account',
                'submenu_text' => 'My account',
                'menu_parent' => '',
                'menu_order' => 1
            )
        );
        $this->registerFrontendUrl(
            array(
                ...
                'menu_text' => 'Logout',
                'submenu_text' => 'Logout',
                'menu_parent' => 'my-account',
                'menu_order' => 1
            )
        );
        $this->registerBackendUrl(
            array('permission' => self::PERMISSION, 'url' => 'users', 'menu_text' => 'Users', 'menu_class' => 'users')
        );
    }
}