...
class Setup extends \Module\Setup {
	public function __construct() {
		parent::__construct();
//		$this->registerFrontendUrl(array('url' => 'login', 'type' => 0, 'mustBeLoggedIn' => 0, 'hiddenForLoggedIn' => 1, 'menu_position' => 1, 'menu_order' => 5, 'menu_text' => '<span class="login">Login</span>'));
		...
		$this->registerBackendUrl(array('permission' => 'View users', 'url' => 'users', 'menu_text' => 'Users', 'menu_class' => 'fal fa-users'));
	}
}