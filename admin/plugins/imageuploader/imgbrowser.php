...
if (\Controller\AdminController::checkPermission('Edit pages')) {
    ...
    <p class="folderInfo"><?php echo $imagebrowser2; ?> <span id="finalcount"></span> <?php echo $imagebrowser3; ?> -
        <span
            id="finalsize"></span>
    ...
    <?php if ($show_settings) { ?>
        <div id="settingsDiv" class="lightbox popout">
            ...
            <!--current version-->
            <p class="uploadP"><img src="img/cd-icon-version.png" class="headerIcon"> <?php echo $currentpluginver; ?>
            </p>

            <br>
            <h3 class="settingsh3"><?php echo $panelsettings16; ?></h3>
            <!--credits-->
            <p class="uploadP"><img src="img/cd-icon-credits.png" class="headerIcon"> <?php echo $panelsettings17; ?>
            </p>
    ...
    <noscript>
        <div class="noscript">
            <div id="folderError" class="noscriptContainer popout">
                <b><?php echo $alerts1; ?></b><br><br><?php echo $alerts5; ?> <a
