...
if(isset($_POST["newpath"])) {
	...
	if($newpath = $useruploadfolder) $data = '
    $useruploadfolder = "' . $newpath . '";
    $useruploadpath = $_ENV["APP_DIR"] . "$useruploadfolder/";
