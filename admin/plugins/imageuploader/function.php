...
function loadImages()
{
    ...
    global $useruploadpath, $file_style, $useruploadfolder, $file_extens, $alerts9, $alerts10;
    if (file_exists($useruploadpath)) {
        ...
        $dir = $useruploadpath;
        $files = glob("$dir*.{jpg,JPG,jpe,JPE,jpeg,JPEG,png,PNG,gif,GIF,ico,ICO}", GLOB_BRACE);
        ...
        for ($i = count($files) - 1; $i >= 0; $i--):
            ...
            $image_url = _FOLDER_URL_ . $useruploadfolder . "/" . $image_basename;
