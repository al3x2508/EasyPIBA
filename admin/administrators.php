<?php
$page_title = __('Edit administrators');
$js = array('plugins/datatables/jquery.dataTables.js','plugins/datatables/fnReloadAjax.js','plugins/datatables/dataTables.bootstrap.js','plugins/iCheck/icheck.min.js','js/jsall.js','js/administrators.js');
$css = array('plugins/datatables/dataTables.bootstrap.css', 'plugins/iCheck/all.css');
$htmlPerms = '';
$permissions = new Model\Model('permissions');
