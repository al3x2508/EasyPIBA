...
class GD extends PHPThumb
{
    ...
    public function show($rawData = false)
    {
        ...
        if ($this->plugins) {
            foreach ($this->plugins as $plugin) {
                /* @var $plugin \Utils\PHPThumb\PluginInterface */
                $plugin->execute($this);
            }
        }
     ...
     *
     * @see \Utils\PHPThumb\GD::$currentDimensions
     */
     ...
     *
     * @see \Utils\PHPThumb\GD::$newDimensions
     */
     ...
     * Returns $oldImage.
     *
     * @see \Utils\PHPThumb\GD::$oldImage
     */
     ...
     *
     * @see \Utils\PHPThumb\GD::$workingImage
     */
